...
function increment_and_update(name, earned_amt){
	cur_balance+=parseInt(earned_amt);
...
function update_display(cval){
	...
	var h_earnings = document.getElementById('hidden_earnings');
    b_display.innerHTML = "Balance: $"+ cval;
    console.log(cval);
    h_balance.value = cval;
	h_earnings.value = earnings;
}
